...
public class mainClass {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("iki cümle yazınız");
        String str=sc.nextLine();
        String str2=sc.nextLine();

        TextClass text=new TextClass();
        System.out.println(text.ilkYarisi(str));
        System.out.println(text.ikinciYarisi(str));
        topla(str,str2);
    ...
    public static void topla(String a,String b){
        ...
        System.out.println(c1.ilkYarisi(a)+c1.ikinciYarisi(b));
    }
}
