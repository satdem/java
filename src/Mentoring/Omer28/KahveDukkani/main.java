...
Elemanın ismi Musteri1 olsun ve parametresi 10 olsun. ---> Musteri1(bakiyem:10); (bakiyem double cinsinden olmalı.)
bakiyem 10 euro
todo  enum  2.
...
todo İPUCU !!!
 Fiyat bilgilerimize main class ımızdan direkt erişilmesini ve değiştirilmesini istemiyoruz.
  Fiyatlara erişebilmek için methodları kullanın.
 ...
 */
    public static void main(String[] args) {
        bakiye m1=bakiye.Musteri1;
        icecekler icecek1=icecekler.LIMONATA;
        double icecekfiyati=icecek1.getfiyat();
        
        Tatlilar tatli1=Tatlilar.CILEKLIPASTA;
        double tatlifiyati=tatli1.getFiyat();
        
        double bakiyem=m1.getBakiye();
        double toplamTutar=icecekfiyati+tatlifiyati;
        double paraustu=bakiyem-toplamTutar;
        
        if (toplamTutar>m1.getBakiye()){
            System.out.println("bakiye yetersiz   Toplam tutar= "+toplamTutar);
        }
        System.out.println("paraustu = " + paraustu);
        
        
        //Tatlilar.CILEKLIPASTA.getFiyat();
        //icecekler.LIMONATA.getfiyat();
       /* System.out.println("para üstü= "+(m1.getBakiye()-Tatlilar.CILEKLIPASTA.getFiyat()-icecekler.LIMONATA.getfiyat()));
        double yenibakiye=m1.getBakiye()-Tatlilar.CILEKLIPASTA.getFiyat()-icecekler.LIMONATA.getfiyat();
